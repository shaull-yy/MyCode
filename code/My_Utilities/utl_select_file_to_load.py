...
class FileSelectorApp:
    ...
    def setup_ui(self):
        ...
        Button(self.root, text="Select File", width=button_width, command=self.select_file).pack(pady=5)
    ...
    def select_file(self):
        ...
        self.selected_file = self.dropdown_var.get()
        if self.selected_file != "Select a file":
